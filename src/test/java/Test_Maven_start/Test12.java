...
//     String Order=FRC.getCell(3).getStringCellValue();
                    ...
                    List<WebElement> count = driver.findElements(By.xpath(("//*[starts-with(@class, ' level-"+D+"  id-')]")));
                    ...
                    switch (Shift) {
                        case 1:
                            ...
                            if ((String.valueOf(Shift)).equals("1")) {
                                String Fshift1 = count.get(21).getAttribute("class");
                                String Fshift2 = count.get(22).getAttribute("class");
                                String Fshift3 = count.get(23).getAttribute("class");
                                if (Fshift1.equalsIgnoreCase(" level-"+D+"  id-slotOpen")) {
                                    driver.findElement(By.xpath("//*[@id='timeSlots']/div/div[2]/div/div[6]/div[2]/div[2]/table/tbody/tr[9]/td["+D+"]")).click();
                                    break;
                                } else if (Fshift2.equalsIgnoreCase(" level"+D+"  id-slotOpen")) {
                                    driver.findElement(By.xpath("//*[@id='timeSlots']/div/div[2]/div/div[6]/div[2]/div[2]/table/tbody/tr[10]/td["+D+"]")).click();
                                    break;
                                } else if (Fshift3.equalsIgnoreCase(" level-"+D+"  id-slotOpen")) {
                                    driver.findElement(By.xpath("//*[@id='timeSlots']/div/div[2]/div/div[6]/div[2]/div[2]/table/tbody/tr[11]/td["+D+"]")).click();
                                    break;
                                } else {
